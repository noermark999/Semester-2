...
public class AppGUI extends Application {
    ...
    private void initStudents() {
        ...
        students.add(new Student("Mark", (Pencil -> this.drawCarMark(new Car(comboBoxPaint.getValue().getColor(), comboBoxDoors.getValue(), comboBoxWheels.getValue()))) ));
        students.add(new Student("Marlene", (Pencil -> this.drawCarMarlene(new Car(comboBoxPaint.getValue().getColor(), comboBoxDoors.getValue(), comboBoxWheels.getValue()))) ));
        students.add(new Student("Mikkel A", (Pencil -> this.drawCarMikkelA(new Car(comboBoxPaint.getValue().getColor(), comboBoxDoors.getValue(), comboBoxWheels.getValue()))) ));
        students.add(new Student("Minik", (Pencil -> this.drawCarMinik(new Car(comboBoxPaint.getValue().getColor(), comboBoxDoors.getValue(), comboBoxWheels.getValue()))) ));
        students.add(new Student("Steffen", (Pencil -> this.drawCarSteffen(new Car(comboBoxPaint.getValue().getColor(), comboBoxDoors.getValue(), comboBoxWheels.getValue()))) ));
    }
    ...
    private void changeCar() {
        ...
        comboBoxStudents.valueProperty().getValue().drawCar(car);
    }
